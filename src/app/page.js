...
import "./globals.css";
import { Phone, Briefcase, ChevronDown, Menu, X, Loader } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen home overflow-x-hidden">
      ...
      <div className="header bg-blue-950 text-white flex flex-row gap-3 justify-end px-4 py-2">
        <h3>www.registerkaro.com</h3>
      ...
      <nav className="bg-white text-blue-800 text-2xl font-bold py-4 shadow-md flex items-center justify-between px-6 md:px-8 w-full">
        ...
        >
          <li className="hover:text-orange-500 cursor-pointer px-6 py-2 md:p-0">Home</li>
          ...
          >
            ...
            {isDropdownOpen && (
              <ul className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-300 shadow-lg rounded-md">
                <li className="px-4 py-2 hover:bg-orange-200 cursor-pointer">Company Registration</li>
          ...
          <Link href="/about">
            <li className="hover:text-orange-500 cursor-pointer px-6 py-2 md:p-0">About</li>
          </Link>
          <li className="hover:text-orange-500 cursor-pointer px-6 py-2 md:p-0">Contact Us</li>
        </ul>
      </nav>
        ...
        {selectedCompany && (
          <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-lg w-full">
            ...
            {loading ? (
              ...
              <p className="text-gray-500">No directors available.</p>
            ) : (
